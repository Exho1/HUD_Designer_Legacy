...
function HD.ToolFunctions(num)
	if num == HD.Tools.Create then -- Create shape
		...
		for i = 1, #HD.Types do
			...
			ShapeType:SetTextColor(color_white)
			ShapeType:SetFont("HD_Smaller")
			ShapeType:SetText("")
			ShapeType:SetTooltip(ToDraw)
			ShapeType.Paint = function()
				draw.RoundedBox(0, 0, 0, ShapeType:GetWide(), ShapeType:GetTall(), color_white)
			...
			ShapeType.DoClick = function()
				...
				elseif ToDraw == "surface.DrawTexturedRect" then
					...
					if color == HD.DefaultCol then color = color_white end
	...
	elseif num == HD.Tools.Demo then
		...
		hook.Add("HUDPaint", "HUD_Designer_Demo", function()
			draw.DrawText("HUD Designer - Demo (WIP)", "HD_Title", 11, 11, color_white)
			draw.DrawText("HUD Designer - Demo (WIP)", "HD_Title", 10, 10, color_black)
				...
				for class, objects in pairs(HD.DrawnObjects[i]) do
					...
					elseif class == "surface.DrawTexturedRect" then
						for id, data in pairs(objects) do
							...
							if color == HD.DefaultCol then color = color_white end -- If not, use white
	...
	elseif num == HD.Tools.Color then -- Open color mixer panel
		...
		Picker:SetTextColor(color_black)
	...
	elseif num == HD.Tools.Layers then
		...
		NewLayer:SetTextColor(color_white)
	...
	elseif num == HD.Tools.Info then
		...
		L_LayCount:SetColor(color_white)
		...
		L_ShaCount:SetColor(color_white)
		...
		L_GridSize:SetColor(color_white)
	...
	elseif num == HD.Tools.Export then
		...
		LabelChoice:SetColor(color_white)
		...
		Console:SetTextColor(color_black)
		Console:SetPos(10, 25)
		Console:SetSize(60, 30)
		Console.Paint = function()
			draw.RoundedBox(0, 0, 0, Console:GetWide(), Console:GetTall(), color_white)
		end
		...
		TxtFile:SetTextColor(color_black)
		TxtFile:SetPos(80, 25)
		TxtFile:SetSize(60, 30)
		TxtFile.Paint = function()
			draw.RoundedBox(0, 0, 0, TxtFile:GetWide(), TxtFile:GetTall(), color_white)
		end
